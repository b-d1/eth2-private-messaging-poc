...
export const getRegistrationCredentials = (idCommitment: string, blsPrivateKey: string, blsPublicKey: string): RegistrationCredentials => {

    const idCommitmentBI: bigint = BigInt(idCommitment);
    const idCommitmentBytes: Uint8Array = new Uint8Array(bigintConversion.bigintToBuf(idCommitmentBI));
